...
/*
ADDED: not present in original implementation
*/
int CDiagramEditor::GetSubMode() const
/* ============================================================
	Function :		CDiagramEditor::GetInteractMode
	Description :	Get the submode.
	Access :		Protected

	Return :		int		-	Current submode
	Parameters :	none

	Usage :			The submode can be one of the
					following:
						"DEHT_NONE" No hit
